...
-- declared in the KonnFav.hs file.
module Settings
    ( hamletFile
    , cassiusFile
    , juliusFile
...
--
-- If you change the resource pattern for StaticR in KonnFav.hs, you will
-- have to make a corresponding change here.
--
-- To see how this value is used, see urlRenderOverride in KonnFav.hs
staticroot :: String
